...
namespace trackFindingTracklet {
  ...
  /*! \class  trackFindingTracklet::AnalyzerKFin
  ...
  void AnalyzerKFin::beginRun(const Run& iEvent, const EventSetup& iSetup) {
    ...
    const int numChannels = trackBuilderChannel_->numChannels() * setup_->numLayers() * setup_->numRegions();
...
DEFINE_FWK_MODULE(trackFindingTracklet::AnalyzerKFin);