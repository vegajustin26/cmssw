...
void HistImp::FillLayerResidual (int layer, int seed, double phiresid, double iphiresid, double zresid, double izresid, bool match) {
  if (layer == 3) {
    if (seed == 0) {
...
void HistImp::FillDiskResidual(int disk, int seed, double phiresid, double iphiresid, double rresid, double irresid, bool match) {
  if (disk == 1) {
    if (seed == 0) {
