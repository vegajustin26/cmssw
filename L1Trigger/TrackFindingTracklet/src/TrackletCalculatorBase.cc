...
void TrackletCalculatorBase::exacttracklet(double r1, double z1, double phi1,
...
void TrackletCalculatorBase::exacttrackletdisk(double r1, double z1, double phi1,
					       double r2, double z2, double phi2, double,
					       double& rinv, double& phi0,
					       double& t, double& z0,
...
void TrackletCalculatorBase::exacttrackletOverlap(double r1, double z1, double phi1,
						  double r2, double z2, double phi2, double,
						  double& rinv, double& phi0,
						  double& t, double& z0,
						  double phiprojLayer[3], double zprojLayer[3], 
...
void TrackletCalculatorBase::exactproj(double rproj,double rinv,double phi0,double t, double z0,
...
void TrackletCalculatorBase::exactprojdisk(double zproj,double rinv,double phi0,
					   double t, double z0,
...
void TrackletCalculatorBase::addProjection(int layer,int iphi,TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet) {
  if (trackletprojs==0) {
...
void TrackletCalculatorBase::addProjectionDisk(int disk,int iphi,TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet) {
...
bool TrackletCalculatorBase::barrelSeeding(Stub* innerFPGAStub, L1TStub* innerStub, Stub* outerFPGAStub, L1TStub* outerStub) {
    ...
    if (!goodTrackPars(ITC->rinv_final.local_passes(),ITC->z0_final.local_passes())) return false;
...
bool TrackletCalculatorBase::diskSeeding(Stub* innerFPGAStub,L1TStub* innerStub,Stub* outerFPGAStub,L1TStub* outerStub) {
...
bool TrackletCalculatorBase::overlapSeeding(Stub* innerFPGAStub, L1TStub* innerStub, Stub* outerFPGAStub, L1TStub* outerStub) {
    ...
    //Protection... Should be handled cleaner to avoid problem with floating point calculation and with overflows in the integer calculation
    if (r1<r2+1.5) {
