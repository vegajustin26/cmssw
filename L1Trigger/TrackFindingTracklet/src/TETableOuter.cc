...
TETableOuter::TETableOuter(const Settings* settings) : TETableBase(settings) { nbits_ = 6; }

TETableOuter::TETableOuter(const Settings* settings, int layer, int zbits, int rbits) : TETableBase(settings) {
  nbits_ = 6;
