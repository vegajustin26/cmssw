...
TETableInner::TETableInner(const Settings* settings) :
  TETableBase(settings) {
  nbits_ = 20;
}

TETableInner::TETableInner(const Settings* settings, int layer1, int layer2, int layer3, int zbits, int rbits, bool thirdLayerIsDisk) :
  TETableBase(settings) {
  nbits_ = 20;
...
void TETableInner::init(const Settings* settings, int layer1, int layer2, int layer3, int zbits, int rbits, bool thirdLayerIsDisk) {
...
double TETableInner::zinterceptL2(double zcut, double z, double r) {
...
double TETableInner::zinterceptL3(double zcut, double z, double r) {
