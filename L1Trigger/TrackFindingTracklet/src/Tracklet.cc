...
Tracklet::Tracklet(const Trklet::Settings* settings, L1TStub* innerStub, L1TStub* middleStub, L1TStub* outerStub,
...
void Tracklet::addMatch(int layer, int ideltaphi, int ideltaz, 
...
void Tracklet::addMatchDisk(int disk, int ideltaphi, int ideltar, 
...
void Tracklet::setFitPars(double rinvfit, double phi0fit, double d0fit, double tfit,
