...
void TrackletCalculatorDisplaced::addProjection(int layer,int iphi,TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet){
  if (trackletprojs==0) {
...
void TrackletCalculatorDisplaced::addProjectionDisk(int disk,int iphi,TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet){
  if (trackletprojs==0) {
...
bool TrackletCalculatorDisplaced::LLLSeeding(Stub* innerFPGAStub, L1TStub* innerStub, Stub* middleFPGAStub, L1TStub* middleStub, Stub* outerFPGAStub, L1TStub* outerStub){
...
bool TrackletCalculatorDisplaced::DDLSeeding(Stub* innerFPGAStub, L1TStub* innerStub, Stub* middleFPGAStub, L1TStub* middleStub, Stub* outerFPGAStub, L1TStub* outerStub){
...
bool TrackletCalculatorDisplaced::LLDSeeding(Stub* innerFPGAStub, L1TStub* innerStub, Stub* middleFPGAStub, L1TStub* middleStub, Stub* outerFPGAStub, L1TStub* outerStub){
...
void TrackletCalculatorDisplaced::exactproj(double rproj,double rinv, double phi0, double d0,
...
void TrackletCalculatorDisplaced::exactprojdisk(double zproj, double rinv, double, double,  //phi0 and d0 are not used.
						double t, double z0,
						double x0, double y0,
...
void TrackletCalculatorDisplaced::exacttracklet(double r1, double z1, double phi1,
