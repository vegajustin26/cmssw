...
TETableInnerDisk::TETableInnerDisk(const Settings* settings) : TETableBase(settings) { nbits_ = 19; }
...
double TETableInnerDisk::rintercept(double zcut, double r, double z) { return (zmeand2_ - zcut) * r / (z - zcut); }
...
double TETableInnerDisk::zintercept(double zcut, double z, double r) { return zcut + (z - zcut) * rmeanl3_ / r; }
