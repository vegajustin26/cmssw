...
L1SimTrack::L1SimTrack(int eventid, int trackid, int type, double pt, double eta, double phi, double vx, double vy, double vz) {
  eventid_=eventid;
  trackid_=trackid;
  type_=type;
  pt_=pt;
...
bool SLHCEvent::addStub(int layer,int ladder,int module, int strip, int eventid, vector<int> tps, 
