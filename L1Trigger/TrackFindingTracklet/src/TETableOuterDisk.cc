...
TETableOuterDisk::TETableOuterDisk(const Settings* settings) : TETableBase(settings) { nbits_ = 5; }

TETableOuterDisk::TETableOuterDisk(const Settings* settings, int disk, int zbits, int rbits) : TETableBase(settings) {
  nbits_ = 5;
