...
public:
  ...
  void init() { h_file_ = new TFile("fpgahist.root", "RECREATE"); }
  ...
  void bookLayerResidual() {
    ...
    h_layerresid_zf_L3_L1L2_match_ =
        new TH1F("L3 zresid float L1L2 Match", "L3 zresid float L1L2 Match", 100, -5.0, 5.0);
  };
