...
public:
  ...
  //
  //
  var_param z1mean{"z1mean", "Kz", settings_->zmax(4), settings_->kz()};
  var_param z2mean{"z2mean", "Kz", settings_->zmax(4), settings_->kz()};

  //inputs
  var_def r1{"r1", "Kr", settings_->rmax(5), settings_->kr()};
  var_def r2{"r2", "Kr", settings_->rmax(5), settings_->kr()};
  var_def z1{"z1", "Kz", settings_->dzmax(), settings_->kz()};
  ...
  //tracklet
  var_add z1abs{"z1abs", &z1, &z1mean, settings_->zmax(4)};
  ...
  var_mult rinv{"rinv", &a2n, &delta0, 4 * settings_->maxrinv()};
