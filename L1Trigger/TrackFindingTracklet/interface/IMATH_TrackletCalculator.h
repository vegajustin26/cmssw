...
public:
 IMATH_TrackletCalculator(const Trklet::Settings* settings, imathGlobals* globals, int i1, int i2) : settings_(settings), globals_(globals) {
  ...
  var_def r2{globals_,"r2", "Kr", settings_->drmax(), settings_->kr()};
  var_def z1{globals_,"z1", "Kz", settings_->zlength(), settings_->kz()};
  var_def z2{globals_,"z2", "Kz", settings_->zlength(), settings_->kz()};
  ...
  //R LUT
  var_inv drinv{globals_,"drinv", &dr, 0, 18, 24, 0, var_inv::mode::both};

  var_subtract dphi{globals_,"dphi", &phi2, &phi1, settings_->dphisector() / 4.};
  var_subtract dz{globals_,"dz", &z2, &z1, 50.};

  var_mult delta0{globals_,"delta0", &dphi, &drinv, delta0_max};
  var_mult deltaZ{globals_,"deltaZ", &dz, &drinv};
  var_mult delta1{globals_,"delta1", &r1abs, &delta0};
  var_mult delta2{globals_,"delta2", &r2abs, &delta0};
  var_mult a2a{globals_,"a2a", &delta1, &delta2, a2a_max};
  ...
  var_add Rabs{globals_,"Rabs", &r1abs, &r2abs};
  var_timesC R6{globals_,"R6", &Rabs, 1. / 6., 12};

  var_mult x4{globals_,"x4", &R6, &delta0};
  var_mult x6a{globals_,"x6a", &delta2, &x4, 0.04};
  ...
  var_mult t{globals_,"t", &a, &deltaZ, 4};
  var_add z0{globals_,"z0", &z1, &z0b, 40.};

  var_adjustK rinv_final{globals_,"rinv_final", &rinv, settings_->kphi1() / settings_->kr()* pow(2, settings_->rinv_shift())};
  var_adjustK phi0_final{globals_,"phi0_final", &phi0, settings_->kphi1()* pow(2, settings_->phi0_shift())};
  var_adjustKR t_final{globals_,"t_final", &t, settings_->kz() / settings_->kr()* pow(2, settings_->t_shift())};
  var_adjustKR z0_final{globals_,"z0_final", &z0, settings_->kz()* pow(2, settings_->z0_shift())};
  ...
  var_mult x1_3{globals_,"x1_3", &x2, &rproj3};
  ...
  var_adjustK phiL_3_final{globals_,"phiL_3_final", &phiL_3, settings_->kphi1()* pow(2, settings_->SS_phiL_shift())};

  var_adjustK der_phiL_final{globals_,"der_phiL_final", &der_phiL, settings_->kphi1() / settings_->kr()* pow(2, settings_->SS_phiderL_shift())};

  var_mult x11_0{globals_,"x11_0", &rproj0, &t};
  var_mult x11_1{globals_,"x11_1", &rproj1, &t};
  var_mult x11_2{globals_,"x11_2", &rproj2, &t};
  var_mult x11_3{globals_,"x11_3", &rproj3, &t};
  ...
  var_mult x23_3{globals_,"x23_3", &x11_3, &x10_3, 400};

  var_add zL_0{globals_,"zL_0", &z0, &x23_0};
  var_add zL_1{globals_,"zL_1", &z0, &x23_1};
  var_add zL_2{globals_,"zL_2", &z0, &x23_2};
  var_add zL_3{globals_,"zL_3", &z0, &x23_3};

  var_adjustKR zL_0_final{globals_,"zL_0_final", &zL_0, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_1_final{globals_,"zL_1_final", &zL_1, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_2_final{globals_,"zL_2_final", &zL_2, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_3_final{globals_,"zL_3_final", &zL_3, settings_->kz()* pow(2, settings_->PS_zL_shift())};

  var_adjustK der_zL_final{globals_,"der_zL_final", &t_final, settings_->kz() / settings_->kr()* pow(2, settings_->PS_zderL_shift())};

  //projection to z
  //
  var_inv invt{globals_,"invt", &t_final, 0., 18, 26, 1, var_inv::mode::both, 13};
  ...
  var_subtract x5_4{globals_,"x5_4", &zproj4, &z0};
  ...
  var_mult x13_4{globals_,"x13_4", &x5_4, &invt, x13_max};

  var_mult x25_0{globals_,"x25_0", &x13_0, &x7, 2 * settings_->dphisector()};
  var_mult x25_1{globals_,"x25_1", &x13_1, &x7, 2 * settings_->dphisector()};
  var_mult x25_2{globals_,"x25_2", &x13_2, &x7, 2 * settings_->dphisector()};
  var_mult x25_3{globals_,"x25_3", &x13_3, &x7, 2 * settings_->dphisector()};
  var_mult x25_4{globals_,"x25_4", &x13_4, &x7, 2 * settings_->dphisector()};
  ...
  var_add phiD_3{globals_,"phiD_3", &phi0, &x25_3, 2 * settings_->dphisector()};
  var_add phiD_4{globals_,"phiD_4", &phi0, &x25_4, 2 * settings_->dphisector()};
  ...
  var_adjustK phiD_4_final{globals_,"phiD_4_final", &phiD_4, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};

  var_mult der_phiD{globals_,"der_phiD", &x7, &invt, 4 * der_phiD_max};

  var_adjustK der_phiD_final{globals_,"der_phiD_final", &der_phiD, settings_->kphi1() / settings_->kr()* pow(2, settings_->SS_phiderD_shift())};
  ...
  var_mult x26_4{globals_,"x26_4", &x25_4, &x25_4};
  ...
  var_nounits x26A_4{globals_,"x26A_4", &x26_4};
  ...
  var_timesC x9_4{globals_,"x9_4", &x26A_4, 1. / 6.};
  ...
  var_subtract x27m_4{globals_,"x27_4", &plus1, &x9_4};

  var_mult rD_0{globals_,"rD_0", &x13_0, &x27m_0, 2 * settings_->rmaxdisk()};
  var_mult rD_1{globals_,"rD_1", &x13_1, &x27m_1, 2 * settings_->rmaxdisk()};
  var_mult rD_2{globals_,"rD_2", &x13_2, &x27m_2, 2 * settings_->rmaxdisk()};
  var_mult rD_3{globals_,"rD_3", &x13_3, &x27m_3, 2 * settings_->rmaxdisk()};
  var_mult rD_4{globals_,"rD_4", &x13_4, &x27m_4, 2 * settings_->rmaxdisk()};
  ...
  var_adjustK rD_4_final{globals_,"rD_4_final", &rD_4, settings_->kr()* pow(2, settings_->PS_rD_shift())};

  var_adjustK der_rD_final{globals_,"der_rD_final", &invt, settings_->kr() / settings_->kz()* pow(2, settings_->PS_rderD_shift())};
  ...
  var_cut z0_final_L1_cut{globals_,-settings_->z0cut(), settings_->z0cut()};
  var_cut z0_final_cut{globals_, -1.5 * settings_->z0cut(), 1.5 * settings_->z0cut()};

  var_cut r1abs_cut{globals_,&r1abs, -settings_->rmax(5), settings_->rmax(5)};
  var_cut r2abs_cut{globals_,&r2abs, -settings_->rmax(5), settings_->rmax(5)};
  ...
  var_cut x8_3_cut{globals_,&x8_3, -x8_max, x8_max};
  ...
  var_cut x13_4_cut{globals_,&x13_4, -x13_max, x13_max};
  ...
  var_cut x25_4_cut{globals_,&x25_4, -settings_->dphisector(), settings_->dphisector()};
  ...
  var_cut phiD_4_cut{globals_,&phiD_4, -2 * settings_->dphisector(), 2 * settings_->dphisector()};
  ...
  var_cut rD_4_cut{globals_,&rD_4, -settings_->rmaxdisk(), settings_->rmaxdisk()};

  var_cut t_disk_cut_left{globals_,&t, -4, -1};
  var_cut t_disk_cut_right{globals_,&t, 1, 4};
  ...
  var_flag valid_phiL_3{globals_,"valid_phiL_3", &phiL_3_final};
  ...
  var_flag valid_zL_3{globals_,"valid_zL_3", &zL_3_final};
  ...
  var_flag valid_phiD_4{globals_,"valid_phiD_4", &phiD_4_final};
  ...
  var_flag valid_rD_4{globals_,"valid_rD_4", &rD_4_final};
