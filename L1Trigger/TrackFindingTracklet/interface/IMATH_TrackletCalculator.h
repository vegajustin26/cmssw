...
public:
  ...
  var_param r2mean{"r2mean", "Kr", settings_->rmax(5), settings_->kr()};
  var_param r12mean{"r12mean", "Kr", 2 * settings_->rmax(5), settings_->kr()};

  //inputs
  var_def r1{"r1", "Kr", settings_->drmax(), settings_->kr()};
  var_def r2{"r2", "Kr", settings_->drmax(), settings_->kr()};
  var_def z1{"z1", "Kz", settings_->zlength(), settings_->kz()};
  var_def z2{"z2", "Kz", settings_->zlength(), settings_->kz()};
  ...
  var_def rproj3{"rproj3", "Kr", settings_->rmax(5), settings_->kr()};
  ...
  var_def zproj4{"zproj4", "Kz", settings_->zmax(4), settings_->kz()};
  ...
  var_mult rinv{"rinv", &a2n, &delta0, 2 * settings_->maxrinv()};
  var_mult t{"t", &a, &deltaZ, 4};
  var_add z0{"z0", &z1, &z0b, 40.};

  var_adjustK rinv_final{"rinv_final", &rinv, settings_->kphi1() / settings_->kr()* pow(2, settings_->rinv_shift())};
  var_adjustK phi0_final{"phi0_final", &phi0, settings_->kphi1()* pow(2, settings_->phi0_shift())};
  var_adjustKR t_final{"t_final", &t, settings_->kz() / settings_->kr()* pow(2, settings_->t_shift())};
  var_adjustKR z0_final{"z0_final", &z0, settings_->kz()* pow(2, settings_->z0_shift())};
  ...
  var_adjustK phiL_0_final{"phiL_0_final", &phiL_0, settings_->kphi1()* pow(2, settings_->SS_phiL_shift())};
  var_adjustK phiL_1_final{"phiL_1_final", &phiL_1, settings_->kphi1()* pow(2, settings_->SS_phiL_shift())};
  var_adjustK phiL_2_final{"phiL_2_final", &phiL_2, settings_->kphi1()* pow(2, settings_->SS_phiL_shift())};
  var_adjustK phiL_3_final{"phiL_3_final", &phiL_3, settings_->kphi1()* pow(2, settings_->SS_phiL_shift())};

  var_adjustK der_phiL_final{"der_phiL_final", &der_phiL, settings_->kphi1() / settings_->kr()* pow(2, settings_->SS_phiderL_shift())};
  ...
  var_adjustKR zL_0_final{"zL_0_final", &zL_0, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_1_final{"zL_1_final", &zL_1, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_2_final{"zL_2_final", &zL_2, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustKR zL_3_final{"zL_3_final", &zL_3, settings_->kz()* pow(2, settings_->PS_zL_shift())};

  var_adjustK der_zL_final{"der_zL_final", &t_final, settings_->kz() / settings_->kr()* pow(2, settings_->PS_zderL_shift())};
  ...
  var_mult x25_0{"x25_0", &x13_0, &x7, 2 * settings_->dphisector()};
  var_mult x25_1{"x25_1", &x13_1, &x7, 2 * settings_->dphisector()};
  var_mult x25_2{"x25_2", &x13_2, &x7, 2 * settings_->dphisector()};
  var_mult x25_3{"x25_3", &x13_3, &x7, 2 * settings_->dphisector()};
  var_mult x25_4{"x25_4", &x13_4, &x7, 2 * settings_->dphisector()};
  ...
  var_add phiD_3{"phiD_3", &phi0, &x25_3, 2 * settings_->dphisector()};
  var_add phiD_4{"phiD_4", &phi0, &x25_4, 2 * settings_->dphisector()};

  var_adjustK phiD_0_final{"phiD_0_final", &phiD_0, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};
  var_adjustK phiD_1_final{"phiD_1_final", &phiD_1, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};
  var_adjustK phiD_2_final{"phiD_2_final", &phiD_2, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};
  var_adjustK phiD_3_final{"phiD_3_final", &phiD_3, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};
  var_adjustK phiD_4_final{"phiD_4_final", &phiD_4, settings_->kphi1()* pow(2, settings_->SS_phiD_shift())};

  var_mult der_phiD{"der_phiD", &x7, &invt, 4 * der_phiD_max};

  var_adjustK der_phiD_final{"der_phiD_final", &der_phiD, settings_->kphi1() / settings_->kr()* pow(2, settings_->SS_phiderD_shift())};
  ...
  var_mult rD_0{"rD_0", &x13_0, &x27m_0, 2 * settings_->rmaxdisk()};
  var_mult rD_1{"rD_1", &x13_1, &x27m_1, 2 * settings_->rmaxdisk()};
  var_mult rD_2{"rD_2", &x13_2, &x27m_2, 2 * settings_->rmaxdisk()};
  var_mult rD_3{"rD_3", &x13_3, &x27m_3, 2 * settings_->rmaxdisk()};
  var_mult rD_4{"rD_4", &x13_4, &x27m_4, 2 * settings_->rmaxdisk()};

  var_adjustK rD_0_final{"rD_0_final", &rD_0, settings_->kr()* pow(2, settings_->PS_rD_shift())};
  var_adjustK rD_1_final{"rD_1_final", &rD_1, settings_->kr()* pow(2, settings_->PS_rD_shift())};
  var_adjustK rD_2_final{"rD_2_final", &rD_2, settings_->kr()* pow(2, settings_->PS_rD_shift())};
  var_adjustK rD_3_final{"rD_3_final", &rD_3, settings_->kr()* pow(2, settings_->PS_rD_shift())};
  var_adjustK rD_4_final{"rD_4_final", &rD_4, settings_->kr()* pow(2, settings_->PS_rD_shift())};

  var_adjustK der_rD_final{"der_rD_final", &invt, settings_->kr() / settings_->kz()* pow(2, settings_->PS_rderD_shift())};
  ...
  var_cut x25_3_cut{&x25_3, -settings_->dphisector(), settings_->dphisector()};
  var_cut x25_4_cut{&x25_4, -settings_->dphisector(), settings_->dphisector()};
  ...
  var_cut phiD_3_cut{&phiD_3, -2 * settings_->dphisector(), 2 * settings_->dphisector()};
  var_cut phiD_4_cut{&phiD_4, -2 * settings_->dphisector(), 2 * settings_->dphisector()};
  ...
  var_cut rD_3_cut{&rD_3, -settings_->rmaxdisk(), settings_->rmaxdisk()};
  var_cut rD_4_cut{&rD_4, -settings_->rmaxdisk(), settings_->rmaxdisk()};
