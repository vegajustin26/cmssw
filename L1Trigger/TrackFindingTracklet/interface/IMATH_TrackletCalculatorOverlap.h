...
public:
  IMATH_TrackletCalculatorOverlap(const Trklet::Settings* settings, int i1, int i2) : settings_(settings) {
  ...
  var_adjustK t_final{"t_final", &t, settings_->kz() / settings_->kr()* pow(2, settings_->t_shift())};
  var_adjustK z0_final{"z0_final", &z0, settings_->kz()* pow(2, settings_->z0_shift())};
  ...
  var_adjustK zL_0_final{"zL_0_final", &zL_0, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustK zL_1_final{"zL_1_final", &zL_1, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  var_adjustK zL_2_final{"zL_2_final", &zL_2, settings_->kz()* pow(2, settings_->PS_zL_shift())};
  ...
  var_mult x25_0{"x25_0", &x13_0, &x7, 4 * settings_->dphisector()};
  var_mult x25_1{"x25_1", &x13_1, &x7, 4 * settings_->dphisector()};
  var_mult x25_2{"x25_2", &x13_2, &x7, 4 * settings_->dphisector()};
  var_mult x25_3{"x25_3", &x13_3, &x7, 4 * settings_->dphisector()};

  var_add phiD_0{"phiD_0", &phi0, &x25_0, 4 * settings_->dphisector()};
  var_add phiD_1{"phiD_1", &phi0, &x25_1, 4 * settings_->dphisector()};
  var_add phiD_2{"phiD_2", &phi0, &x25_2, 4 * settings_->dphisector()};
  var_add phiD_3{"phiD_3", &phi0, &x25_3, 4 * settings_->dphisector()};
  ...
  var_mult rD_0{"rD_0", &x13_0, &x27m_0, settings_->rmaxdisk()};
  var_mult rD_1{"rD_1", &x13_1, &x27m_1, settings_->rmaxdisk()};
